...
|---|---|---|
| Financial signals | 1 signal chính | Nhiều signal và supporting indicators |
...
| Control evidence | 1 control rule + 1 exception/timing clue | Nhiều control conditions và payment patterns |
| Suspects | 2–3 simplified suspect profiles | 4 executive dossiers đầy đủ |
