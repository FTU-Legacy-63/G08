...
- Satyam Computer Services (The Guardian): Xác nhận hiện tượng "BCTC khỏe nhưng economic reality yếu hơn" là có thật. Khớp trực tiếp với revenue, net_income, ocf trong Input Dictionary và phép tính OCF/NI ở Early Logic Test.
- Damodaran Online, CSIMarket (phần OCF/NI): Xác nhận benchmark OCF/NI ≥ 1 có căn cứ học thuật, dù ngưỡng cụ thể là do nhóm tự đặt. Khớp với cùng bộ field trên.
---
