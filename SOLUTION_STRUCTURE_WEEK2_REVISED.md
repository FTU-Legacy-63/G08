...
**Quy tắc progression:** gating question quyết định điểm số của chặng nhưng không được phép chặn vĩnh viễn dữ liệu cần cho các chặng sau. Nếu người chơi trả lời sai, chặng đó ghi nhận 0 điểm và hệ thống hiển thị guided feedback/remediation; sau đó bộ bằng chứng tối thiểu của bước kế tiếp vẫn được mở để người chơi có thể hoàn thành toàn bộ hành trình end-to-end.
...
- Ở mức Week 2, thông tin bao gồm: xu hướng doanh thu, lợi nhuận và dòng tiền hoạt động, cùng với tín hiệu **Cash Conversion** = dòng tiền hoạt động / lợi nhuận ròng. Đây là tín hiệu chính của MVP, dựa trên logic earnings quality và cash conversion: lợi nhuận báo cáo tăng nhưng dòng tiền hoạt động không tăng tương ứng là một dấu hiệu cần điều tra thêm, chưa phải là một kết luận. Đây là logic sàng lọc của case, không phải một cutoff phổ quát.
- Nhóm thông tin này còn bao gồm chi phí advisory hoặc chênh lệch so với ngân sách nội bộ.
- Ở Target Product, bổ sung một tín hiệu thứ hai gọi là **DSRI** (Days Sales in Receivables Index), dùng để **kiểm tra và đánh giá lại giả thuyết liên quan đến doanh thu/phải thu**. Tùy kết quả, tín hiệu này có thể làm mạnh lên hoặc làm yếu đi giả thuyết revenue-quality; nó không được thiết kế để mặc định loại trừ giả thuyết ngay từ đầu. Tín hiệu này không thuộc phạm vi MVP.
...
> Phần responsibility sử dụng một **qualitative responsibility lens** để phân biệt authorization, execution, review và monitoring khi xây dựng bằng chứng và phản hồi cho từng nhân vật. Phần này **không** phải là một trục chấm điểm riêng biệt và không thay thế bằng chứng liên kết trực tiếp như Amendment History hoặc Employee Directory.
...
| 2 | DSRI | Target Product | Kiểm tra và đánh giá lại giả thuyết liên quan đến doanh thu/phải thu |
| 3 | Substance over form | MVP | Đánh giá hiện tượng chia nhỏ thanh toán so với ngưỡng phê duyệt |
| 4 | Qualitative responsibility lens | Định tính, cả hai | Phân biệt authorization, execution, review và monitoring; không phải một bước tính điểm riêng |
...
- Việc mở khóa bằng chứng diễn ra theo trình tự tuyến tính nhưng **không làm đứt investigation chain khi người chơi trả lời sai**. Trả lời đúng mở bằng chứng ngay và nhận 20 điểm; trả lời sai nhận 0 điểm ở chặng đó, hệ thống cung cấp guided feedback/remediation rồi vẫn mở bộ bằng chứng tối thiểu cần thiết để người chơi tiếp tục sang chặng kế tiếp.
...
- DSRI không phải là input mà người chơi phải tự tính toán trong MVP; qualitative responsibility lens chỉ xuất hiện trong cách tổ chức bằng chứng và phản hồi, không phải một bài tính hay trục điểm riêng.
