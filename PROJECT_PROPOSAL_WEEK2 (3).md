...
Tín hiệu khởi đầu của quá trình điều tra dựa trên một logic earnings quality có thật (nguyên lý Sloan): lợi nhuận tăng nhưng dòng tiền hoạt động không tăng tương ứng chỉ là một chỉ báo sàng lọc, không phải bằng chứng kết luận. Người chơi buộc phải tiếp tục truy vết để xác định nguyên nhân thực sự.
...
| Gameplay | Tuyến tính hoặc phân nhánh nhẹ | Cơ chế mở khóa bằng chứng và phân nhánh phong phú hơn |
